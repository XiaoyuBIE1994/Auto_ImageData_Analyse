# -*- coding: utf-8 -*-
"""
Created on Sun May 26 19:15:54 2019
    ...
    for file in files:
        if "Archive" in subdir:
            ...
            if ".PNG" in file:
                ...
                pt1, pt2 = Intergration.model_run (imagepath, data_color_range, start_ratio, vert_ratio_num, vert_ratio_gap, ransac_params,\
                                      find_corner_params, find_mark_params, find_coor_params,find_peak_params,\
                                      MODE_CHECK, SHOW_RANSAC_LINE, CHECK_RESULT)
                
                data_in = input("E: exit, others: continue")
                if data_in == "E":
                    break
                os.system('cls')